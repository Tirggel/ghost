...
class SkillManager {
  ...
  Future<Skill> installSkillFromDirectory(String sourcePath, {bool moveSource = false, bool overwrite = true}) async {
    ...
    // Handle duplicates
    if (overwrite) {
      final target = Directory(p.join(skillsDir, foundSlug));
      if (await target.exists()) {
        _log.info('Overwriting existing skill: $foundSlug');
